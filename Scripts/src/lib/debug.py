...
def debug(srcPath, template, coupon):
    ...
    try:
        masterDatabaseJson = open(srcPath+'/database/coupon_master.json', 'r')
        ...
        couponDatabaseJson = open(srcPath+'/database/'+template.lower()+'.json', 'r')
        ...
        execfile(srcPath+'/class/coupon_generic.py', globals())
        execfile(srcPath+'/class/'+template.lower()+'.py', globals())
