...
class coupon_09_fracture_22_36(coupon_generic):
    ...
    def createPartition(self):
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yC1)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yB)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yC)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yC1-abs(self.yC1-self.yC))
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yE-self.xC1)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', self.yD)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'YZPLANE', self.xO)
        for i in range(2):
            self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'YZPLANE', (-1)**i*self.xC1)
            self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'YZPLANE', (-1)**i*(self.xC1+(self.xC1-self.xD)))
            ...
            self.createPartitionByDatumPlane(self.part[0], cellLowerBox, 'YZPLANE', (-1)**i*self.xD)
        self.createPartitionByDatumPlane(self.part[1], self.part[1].cells, 'YZPLANE', self.xO)
        self.createPartitionByDatumPlane(self.part[1], self.part[1].cells, 'XYPLANE', self.pinLenFactor/2.0*self.thickness)
        self.createPartitionByDatumPlane(self.part[1], self.part[1].cells, 'XYPLANE', (1+self.pinLenFactor/2.0)*self.thickness)
