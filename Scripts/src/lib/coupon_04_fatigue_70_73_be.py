...
class coupon_04_fatigue_70_73_be(coupon_generic):
    def __init__(self, couponData):
        super(coupon_04_fatigue_70_73_be, self).__init__(couponData)
        ## initialize the user-defined parameters; dimensional inputs converted to float to avoid truncation while division
        self.h1 = self.geometry['h1']
        self.h2 = self.geometry['h2']
        self.h3 = self.geometry['h3']
        ...
        self.seedSizeVerticalOuter = self.seedSize['verticalOuter']
        self.seedSizeVerticalMiddle = self.seedSize['verticalMiddle']
        self.seedSizeVerticalInner = self.seedSize['verticalInner']
        self.seedSizeVertical2 = self.seedSize['vertical2']
        ...
        ## derived quantities
        self.partitionVerticalFraction = 0.67
        ...
        self.endStress = -self.stepLoad*self.h1/self.h3
        ## create coupon
        self.createModel()
