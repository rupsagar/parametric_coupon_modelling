...
class coupon_10_crack_44_50(coupon_generic):
    ...
    def createPartition(self):
        for i in range(2):
            self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', (-1)**i*0.5*self.notchWidth)
            self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', (-1)**i*0.5*self.notchLength)
            self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'YZPLANE', (-1)**i*0.5*self.notchLength)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'XZPLANE', 0)
        self.createPartitionByDatumPlane(self.part[0], self.part[0].cells, 'YZPLANE', 0)
