...
class gui():
    def __init__(self, abqPath, srcPath):
        ...
        couponMasterJson = open(self.srcPath+'/db/coupon_master.json', 'r')
        ...
        couponGUIJson = open(self.srcPath+'/db/coupon_gui.json', 'r')
        couponGUIDictUnicode = json.load(couponGUIJson)
        couponGUIJson.close()
        self.GUIDatabase = ast.literal_eval(json.dumps(couponGUIDictUnicode))
        ## clear old cache files
        if os.path.isdir(self.srcPath+'/lib/__pycache__'):
            shutil.rmtree(self.srcPath+'/lib/__pycache__')
        self.createGUI()
    def createGUI(self):
        ## create GUI
    ...
    def radioSelection(self):
        ...
        self.couponDatabaseJson = open(self.srcPath+'/db/'+self.templateDropDown.get().lower()+'.json', 'r')
