...
couponDatabasePath = r'D:\Academic_To_be_uploaded\Programming\git\abaqus_scripts\Coupon_Mark_BJ'
...
# couponModelList = []
# for thisCoupon in couponMarkBJDatabase:
#         couponModelList.append(couponMarkBJ(couponMarkBJDatabase[thisCoupon]))
